...
import { registerUserController, loginUserController, refreshUserController, logoutUserController, sendResetEmailUserController, resetUserPasswordController } from "../controllers/auth.js";
...
registerRouter.post('/reset-pwd', validateBody(resetPasswordSchema), ctrlWrapper(resetUserPasswordController));
